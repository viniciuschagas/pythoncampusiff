# -*- coding: utf-8 -*-
# Django settings for pythoncampusiff project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'pythoncampusiff.db',           # Or path to database file if using sqlite3.
...
MEDIA_ROOT = os.path.join(PROJECT_ROOT_PATH, 'pythoncampusiff_base/site_media')
...
SECRET_KEY = 'ore@7g#yyr5%h#d@xn$1vhzn@$#_1rm%$8#8p*y#gyr_$5n2t$'
...
ROOT_URLCONF = 'pythoncampusiff.urls'
